...
//        DB::table('core_permissions')->delete();
        ...
        $permissions = array(
            ...
            ['id'=>171,'module'=>'HotelRoomCategory','name'=>'New','description'=>'Hotel Room Category New','url'=>'backend/hotel_room_category/create/{hotel_id?}'],
            ...
            ['id'=>176,'module'=>'HotelRoomCategory','name'=>'Filter with Hotel_id','description'=>'Hotel Room Category Filter','url'=>'backend/hotel_room_category/{hotel_id?}'],
