...
<div id="content" class="content">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
            <textarea  rows="5" cols="50" class="form-control" id="description" name="description" placeholder="Enter Role Description" >{{ isset($roles)? $roles->description:Request::old('description') }}</textarea>
