...
<div id="content" class="content">
    ...
    @if(isset($permission))
        {!! Form::open(array('url' => 'backend_mps/permission/update', 'class'=> 'form-horizontal user-form-border')) !!}

    @else
        {!! Form::open(array('url' => 'backend_mps/permission/store', 'class'=> 'form-horizontal user-form-border')) !!}
    @endif
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
            <textarea rows="5" cols="50" class="form-control" id="description" name="description" placeholder="Enter Role Description" >{{ isset($permission)? $permission->description:Request::old('description') }}</textarea>
