...
<div id="content" class="content">
    ...
    {{--check new or edit--}}
    @if(isset($user))
        {!! Form::open(array('url' => '/backend_mps/user/update', 'class'=> 'form-horizontal user-form-border')) !!}

    @else
        {!! Form::open(array('url' => '/backend_mps/user/store', 'class'=> 'form-horizontal user-form-border')) !!}
    @endif
