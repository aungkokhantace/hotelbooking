...
<div id="content" class="content">
    ...
    <h1 class="page-header">{{trans('setup_hotelconfig.title-list')}}</h1>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="buttons pull-right">
                <button type="button" onclick='create_setup("hotel_config");' class="btn btn-default btn-md first_btn">
                    <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                </button>
                <button type="button" onclick='edit_setup("hotel_config");' class="btn btn-default btn-md second_btn">
                    <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                </button>
                <button type="button" onclick="delete_setup('hotel_config');" class="btn btn-default btn-md third_btn">
