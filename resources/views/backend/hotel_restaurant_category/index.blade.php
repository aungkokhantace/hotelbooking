...
<div id="content" class="content">
    ...
    {!! Form::open(array('id'=> 'frm_user' ,'url' => 'backend/hotel_restaurant_category/destroy', 'class'=> 'form-horizontal user-form-border')) !!}
    {{ csrf_field() }}
            ...
            <div class="listing">
                ...
                <table class="table table-striped list-table" id="list-table">
                    ...
                    <tr>
                        ...
                        <th>Hotel Restaurant Category Name</th>
                    ...
                    <tr>
                        ...
                        <th class="search-col" con-id="display_name">Hotel Restaurant Category Name</th>
