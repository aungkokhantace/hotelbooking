...
<div id="content" class="content">
    ...
    <h1 class="page-header">{{isset($hotel_nearby_station) ?  'Hotel Nearby Station Edit' : 'Hotel Nearby Station Entry' }}</h1>
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
            <input type="text" required class="form-control" id="name" name="name"
                   placeholder="Enter Station Name" value="{{ isset($hotel_nearby_station)? $hotel_nearby_station->name:Request::old('name') }}"/>
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
            <input type="text" required class="form-control" id="distance" name="distance"
                   placeholder="Enter Distance" value="{{ isset($hotel_nearby_station)? $hotel_nearby_station->distance:Request::old('distance') }}"/>
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
            <textarea rows="5" cols="50" class="form-control" id="remark" name="remark" placeholder="Enter Remark">{{ isset($hotel_nearby_station)? $hotel_nearby_station->remark:Request::old('remark') }}</textarea>
    ...
    <div class="row">
        ...
        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
            <input type="submit" name="submit" value="{{isset($hotel_nearby_station)? 'UPDATE' : 'ADD'}}" class="form-control btn-primary">
        </div>
        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
            <input type="button" value="CANCEL" class="form-control cancel_btn" onclick="cancel_setup('hotel_nearby_station')">
        </div>
    </div>
    {!! Form::close() !!}
</div>
