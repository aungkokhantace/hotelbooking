...
<div id="content" class="content">
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="buttons pull-right">
                <button type="button" onclick='create_setup("facilities");' class="btn btn-default btn-md first_btn">
                    <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                </button>
                <button type="button" onclick='edit_setup("facilities");' class="btn btn-default btn-md second_btn">
                    <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                </button>
                <button type="button" onclick="delete_setup('facilities');" class="btn btn-default btn-md third_btn">
    ...
    {!! Form::open(array('id'=> 'frm_facilities' ,'url' => '/backend_mps/facilities/destroy', 'class'=> 'form-horizontal user-form-border')) !!}
    {{ csrf_field() }}
                ...
                <table class="table table-striped list-table" id="list-table">
                    ...
                    @foreach($facilities as $facility)
                        <tr>
                            ...
                            <td><a href="/backend_mps/facilities/edit/{{$facility->id}}">{{$facility->name}}</a></td>
