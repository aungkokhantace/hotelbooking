...
<div id="content" class="content">
    ...
    <div class="row">
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
            <label for="country_id">Facilities Name <span class="require">*</span></label>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
            <input required type="text" class="form-control" id="facilities_name" name="facilities_name"
                   placeholder="Enter Facilities Name" value="{{ isset($facilities)? $facilities->facilities_name:Request::old('facilities_name') }}"/>
            <p class="text-danger">{{$errors->first('facilities_name')}}</p>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
