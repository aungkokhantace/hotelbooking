...
<div id="content" class="content">
    ...
    <h1 class="page-header">{{trans('setup_hotelgallery.title-list')}}</h1>
    <br>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="buttons pull-right">
                ...
                @endif
                <button type="button" onclick='edit_setup("hotel_gallery");' class="btn btn-default btn-md second_btn">
                    <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                </button>

                @if($role !== 3)
                <button type="button" onclick="delete_setup('hotel_gallery');" class="btn btn-default btn-md third_btn">
    ...
    {!! Form::open(array('id'=> 'frm_hotel_gallery' ,'url' => 'backend_mps/hotel_gallery/destroy', 'class'=> 'form-horizontal user-form-border')) !!}
    {{ csrf_field() }}
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="listing">
                ...
                <table class="table table-striped list-table" id="list-table">
                    ...
                    <tbody>
                    @foreach($all_hotel_gallery as $hotel_gallery)
                        <tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick='create_setup_room_category("hotel_gallery");'>Go To Hotel Gallery Form</button>
            </div>
        </div>
    </div>
</div>
