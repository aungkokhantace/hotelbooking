                ...
                <select class="form-control" name="hotel_id" id="hotel_id">
                    @if(isset($r_available_period))
                        @foreach($hotels as $hotel)
                            @if($hotel->id == $r_available_period->hotel_id)
                ...
                <select class="form-control" name="room_id" id="room_id">
                    @if(isset($r_available_period))
                        @foreach($rooms as $room)
                            @if($room->id == $r_available_period->room_id)
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                <div class="input-group date dateTimePicker" data-provide="datepicker" id="datepicker_from">
                    <input type="text" class="form-control date-value-box" id="from_date" name="from_date" value="{{isset($r_available_period)? \Carbon\Carbon::parse($r_available_period->from_date)->format('d-m-Y') : ''}}">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                <div class="input-group date dateTimePicker" data-provide="datepicker"  id="datepicker_to">
                    <input type="text" class="form-control date-value-box" id="to_date" name="to_date" value="{{isset($r_available_period)? \Carbon\Carbon::parse($r_available_period->to_date)->format('d-m-Y') : ''}}">
                    <div class="input-group-addon">
                        <span class="glyphicon glyphicon-calendar"></span>
                    </div>
                </div>
