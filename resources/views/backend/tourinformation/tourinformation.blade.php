...
<div id="content" class="content">
    ...
    {!! Form::open(array('url' => '/backend/tour_information', 'class'=> 'form-horizontal user-form-border','files' => true)) !!}
    <input type="hidden" name="_token" value="{{ csrf_token() }}">

    <div class="row">
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
            <label for="description" class="text_bold_black">Tour Information Text</label>
        </div>
        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
            <textarea class="form-control" id="description" name="description" placeholder="Enter Tour Information Text" rows="5" cols="50">{{ isset($tourInformation)? $tourInformation["description"]:Request::old('description') }}</textarea>
