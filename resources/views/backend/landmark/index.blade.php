    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="buttons pull-right">
                <button type="button" onclick='create_setup("landmark");' class="btn btn-default btn-md first_btn">
                    <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                </button>
                <button type="button" onclick='edit_setup("landmark");' class="btn btn-default btn-md second_btn">
                    <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                </button>
                <button type="button" onclick="delete_setup('landmark');" class="btn btn-default btn-md third_btn">
            ...
            <div class="listing">
                ...
                <table class="table table-striped list-table" id="list-table">
                    ...
                    <tr>
                        ...
                        <th class="search-col" con-id="popular">Popular</th>
