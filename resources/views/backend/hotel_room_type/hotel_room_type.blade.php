...
<div id="content" class="content">
    ...
    <h1 class="page-header">{{isset($hotel_room_type) ?  'Hotel Room Type Edit' : 'Hotel Room Type Entry' }}</h1>
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
            <input type="text" required class="form-control" id="name" name="name"
                   placeholder="Enter Hotel Room Type Name" value="{{ isset($hotel_room_type)? $hotel_room_type->name:Request::old('name') }}"/>
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
            <textarea rows="5" cols="50" class="form-control" id="description" name="description" placeholder="Enter Hotel Room Type Description">{{ isset($hotel_room_type)? $hotel_room_type->description:Request::old('description') }}</textarea>
    ...
    <div class="row">
        ...
        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
            <input type="button" value="CANCEL" class="form-control cancel_btn" onclick="cancel_setup('hotel_room_type')">
        </div>
    </div>
    {!! Form::close() !!}
</div>
