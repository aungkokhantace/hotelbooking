...
<div id="content" class="content">
    ...
    @if(isset($r_category_amenity))
        {!! Form::open(array('url' => '/backend_mps/room_category_amenity/update','id'=>'r_category_amenity', 'class'=> 'form-horizontal user-form-border')) !!}

    @else
        {!! Form::open(array('url' => '/backend_mps/room_category_amenity/store','id'=>'r_category_amenity', 'class'=> 'form-horizontal user-form-border')) !!}
    @endif
