            ...
            <tr class="tr_product_detail_" id="tr_product_detail_">
                <td>
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <select class="form-control" id="nearby_place" name="nearby_place[]">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <input type="text" id="nearby_distance" name="nearby_distance[]" placeholder="{{trans('setup_hotel.nearby-distance')}}"/>
                            @if (isset($disCount))
