...
<div id="content" class="content">
    ...
    <div class="row">
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
            <label for="description_en" class="text_bold_black">VISA Information Text [English]</label>
        </div>
        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
            <textarea class="form-control text-area" id="description_en" name="description_en" placeholder="Enter Transportation Information Text in English" rows="5" cols="50">{{ isset($visaInformation)? $visaInformation["description_en"]:Request::old('description_en') }}</textarea>
    ...
    <div class="row">
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
            <label for="description_jp" class="text_bold_black">VISA Information Text [Japanese]</label>
        </div>
        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
            <textarea class="form-control text-area" id="description_jp" name="description_jp" placeholder="Enter Transportation Information Text in Japanese" rows="5" cols="50">{{ isset($visaInformation)? $visaInformation["description_jp"]:Request::old('description_jp') }}</textarea>
