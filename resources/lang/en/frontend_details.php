...
return[
  ...
  "dinner-close-hour" => "Dinner End Time",
	...
	"are_you_booking_for_someone_else"=>"Are you making a reservation for someone else?",
	"mention_someone_else"=>"If you are making a reservation for someone else, please specify name and email!",
	"yes"=>"Yes",
	"no"=>"No",
