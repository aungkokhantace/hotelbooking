...
class PaymentRepository implements PaymentRepositoryInterface
{
    ...
    public function create($paramObj){
        ...
        try {
            ...
            $message = '['. $date .'] '. 'info: ' . 'Customer '.$loginUserId.' created payment_id = '.$paramObj->id . PHP_EOL;
            ...
            $message = '['. $date .'] '. 'error: ' . 'Customer '.$loginUserId.' created a payment and got error -------'.$e->getMessage(). ' ----- line ' .$e->getLine(). ' ----- ' .$e->getFile(). PHP_EOL;
            LogCustom::create($date,$message);
