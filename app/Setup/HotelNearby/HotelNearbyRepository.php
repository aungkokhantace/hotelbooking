...
class HotelNearbyRepository implements HotelNearbyRepositoryInterface
{
    public function getObjs()
    {
        $objs       = HotelNearby::whereNull('deleted_at')->get();
        return $objs;
    }

    public function getArrays()
    {
        $tbName = (new HotelNearbyCategory())->getTable();
