 ...
 * Time: 8:49 PM
 */
class RoomCategoryFacilityRepository implements RoomCategoryFacilityRepositoryInterface
{
    public function getObjs()
    {
        $objs = RoomCategoryFacility::whereNull('deleted_at')->get();
        return $objs;
    }

    public function getArrays()
    {
        $tbName = (new RoomCategoryFacility())->getTable();
    ...
    {
        $obj = RoomCategoryFacility::find($id);
        return $obj;
    }
    ...
    public function delete($id)
    {
        ...
        try{
            $tempObj = RoomCategoryFacility::find($id);
