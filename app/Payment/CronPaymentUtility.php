...
/*
  This class is for payment actions via cron job.
  The difference is only in log actions ( ** this class uses cron log function in LogCustom )
  To AVOID the problem with write permission to log file
  ** (file owner is *root* if log file is created by cronjob, thus unable to write by normal operation logs)
*/

class CronPaymentUtility
{
