...
class GuideInformationController extends Controller
{
    ...
    {
        // $temp_data = DB::select("SELECT * FROM `service_price` WHERE `type` = 'GUIDE' LIMIT 1");
        $temp_data = DB::select("SELECT * FROM `display_information` WHERE `type` = 'GUIDE' LIMIT 1");
        ...
        return view('frontend.guideinformation')->with('page_data',$page_data);
    }
