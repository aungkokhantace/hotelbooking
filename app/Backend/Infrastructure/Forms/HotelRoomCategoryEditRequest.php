...
class HotelRoomCategoryEditRequest extends Request
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'name'                  => 'required|unique:h_room_category,name,'.$this->get('id').',id,hotel_id,'.Input::get('hotel_id').',deleted_at,NULL',
