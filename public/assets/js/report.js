...
function report_search_with_type(module){
    ...
    if(type == "yearly"){           //type is yearly
        ...
        if(from_year == "" && to_year == ""){
            ...
            if(dateComparison){
                form_action = "/backend_mps/"+module+"/search/" + type + "/" + from_year + "/" + to_year;
        ...
        if(from_month == "" && to_month == ""){
            ...
            if(dateComparison){
                form_action = "/backend_mps/"+module+"/search/" + type + "/" + from_month + "/" + to_month;
        ...
        if(from_date == "" && to_date == ""){
            ...
            if(dateComparison){
                form_action = "/backend_mps/"+module+"/search/" + type + "/" + from_date + "/" + to_date;
...
function report_export_with_type(module){
    ...
    if(type == "yearly"){           //type is yearly
        ...
        if(from_month == "" && to_month == ""){
            ...
            if(dateComparison){
                form_action = "/backend_mps/"+module+"/exportexcel/" + type + "/" + from_month + "/" + to_month;
                if(status != undefined){
                    form_action += "/"+status;
                }
            }
        ...
        if(from_date == "" && to_date == ""){
            var form_action = "/backend_mps/"+module+"/exportexcel";
        }
        else if(from_date == "" && to_date != "") {
            sweetAlert("Oops...", "Please Choose the date !");
            return;
